...
matches the contract documented in ``contracts/bridge_contract.md``. It does
NOT contain any Qiskit Metal logic — service implementations live in
``services/`` and are intentionally left as ``NotImplementedError`` stubs.
"""
