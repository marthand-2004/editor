...
from ..models import DesignDocument, GeneratedCode
...
class CodegenService:
    ...
    def generate(self, design: DesignDocument) -> GeneratedCode:
        ...
        for connection in design.connections:
            ...
            route_lines.extend(
                [
                    f"route_{short_id} = {route_id}("
                    f"design, 'route_{short_id}', options=dict(",
                    "    pin_inputs=dict(",
                    "        start_pin=dict("
                    f"component={source_name!r}, "
                    f"pin={connection.from_.pinName!r}),",
                    "        end_pin=dict("
                    f"component={target_name!r}, "
                    f"pin={connection.to.pinName!r}),",
                    "    ),",
                    *(
