...
These routes delegate to the service layer. None of the services are
implemented yet — they will raise ``NotImplementedError``, which the global
exception handler converts to a 501 response with the standard error envelope.
"""
